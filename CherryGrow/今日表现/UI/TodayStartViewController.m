...
- (NSArray<UIViewController*>*) controllers{
    if (!_controllers) {
        NSArray<NSString*>* classnames = @[@"MealSituationStartViewController", @"SleepSituationStartViewController", @"StudySituationStartViewController", @"GeneralSituationStartCommonViewController"];
